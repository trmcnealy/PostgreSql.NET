...
namespace PostgreSql
{
    ...
    public static partial class NativeLibrary
    {
        ...
        //public static readonly nuint libsslHandle;

        //public const string libcryptoLibraryName = "libcrypto-1_1-x64";

        //public static readonly nuint libcryptoHandle;

        //public const string libintlLibraryName = "libintl-8";

        //public static readonly nuint libintlHandle;

        //public const string libiconvLibraryName = "libiconv-2";

        //public static readonly nuint libiconvHandle;
        ...
        static NativeLibrary()
        {
            ...
            LibraryPath = Path.Combine(libraryPath,
        ...
        public static ReadOnlySpan<byte> PQnoPasswordSupplied => new byte[]
        {
            0x66,
            0x65,
            0x5F,
        ...
        internal static unsafe void Load()
        {
            if(!IsLoaded)
            {
                Handle = PlatformApi.NativeLibrary.LoadByName(LibraryName,
                                                              LibraryPath);
                ...
                PQconnectStart                  = (delegate*<utf8cstring, pg_conn>)(Handle                                                                               + PQconnectStartRVA);
                ...
                PQconnectdb                     = (delegate*<utf8cstring, pg_conn>)(Handle                                                                               + PQconnectdbRVA);
                PQconnectdbParams               = (delegate*<utf8string*, utf8string*, int, pg_conn>)(Handle                                                             + PQconnectdbParamsRVA);
                PQsetdbLogin                    = (delegate*<utf8cstring, utf8cstring, utf8cstring, utf8cstring, utf8cstring, utf8cstring, utf8cstring, pg_conn>)(Handle + PQsetdbLoginRVA);
                PQfinish                        = (delegate*<pg_conn, void>)(Handle                                                                                      + PQfinishRVA);
                PQconndefaults                  = (delegate*<ref PQconninfoOption>)(Handle                                                                               + PQconndefaultsRVA);
                PQconninfoParse                 = (delegate*<utf8cstring, utf8string*, ref PQconninfoOption>)(Handle                                                     + PQconninfoParseRVA);
                ...
                PQcancel                        = (delegate*<pg_cancel, utf8string, int, int>)(Handle                                                                    + PQcancelRVA);
                PQrequestCancel                 = (delegate*<pg_conn, int>)(Handle                                                                                       + PQrequestCancelRVA);
                PQdb                            = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQdbRVA);
                PQuser                          = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQuserRVA);
                PQpass                          = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQpassRVA);
                PQhost                          = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQhostRVA);
                PQhostaddr                      = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQhostaddrRVA);
                PQport                          = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQportRVA);
                PQtty                           = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQttyRVA);
                PQoptions                       = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQoptionsRVA);
                ...
                PQparameterStatus               = (delegate*<pg_conn, utf8cstring, utf8cstring>)(Handle                                                                  + PQparameterStatusRVA);
                ...
                PQerrorMessage                  = (delegate*<pg_conn, utf8string>)(Handle                                                                                + PQerrorMessageRVA);
                ...
                PQsetClientEncoding             = (delegate*<pg_conn, utf8cstring, int>)(Handle                                                                          + PQsetClientEncodingRVA);
                PQsslInUse                      = (delegate*<pg_conn, int>)(Handle                                                                                       + PQsslInUseRVA);
                PQsslStruct                     = (delegate*<pg_conn, utf8cstring, nuint>)(Handle                                                                        + PQsslStructRVA);
                PQsslAttribute                  = (delegate*<pg_conn, utf8cstring, utf8cstring>)(Handle                                                                  + PQsslAttributeRVA);
                PQsslAttributeNames             = (delegate*<pg_conn, utf8cstring*>)(Handle                                                                              + PQsslAttributeNamesRVA);
                PQgetssl                        = (delegate*<pg_conn, nuint>)(Handle                                                                                     + PQgetsslRVA);
                ...
                PQgetgssctx                     = (delegate*<pg_conn, nuint>)(Handle                                                                                     + PQgetgssctxRVA);
                ...
                PQsetNoticeReceiver             = (delegate*<pg_conn, PQnoticeReceiver, nuint, PQnoticeReceiver>)(Handle                                                 + PQsetNoticeReceiverRVA);
                PQsetNoticeProcessor            = (delegate*<pg_conn, PQnoticeProcessor, nuint, PQnoticeProcessor>)(Handle                                               + PQsetNoticeProcessorRVA);
                PQregisterThreadLock            = (delegate*<pgthreadlock_t, pgthreadlock_t>)(Handle                                                                     + PQregisterThreadLockRVA);
                PQexec                          = (delegate*<pg_conn, utf8cstring, pg_result>)(Handle                                                                    + PQexecRVA);
                PQexecParams                    = (delegate*<pg_conn, utf8cstring, int, Oid*, utf8string*, int*, int*, int, pg_result>)(Handle                           + PQexecParamsRVA);
                PQprepare                       = (delegate*<pg_conn, utf8cstring, utf8cstring, int, Oid*, pg_result>)(Handle                                            + PQprepareRVA);
                PQexecPrepared                  = (delegate*<pg_conn, utf8cstring, int, utf8string*, int*, int*, int, pg_result>)(Handle                                 + PQexecPreparedRVA);
                PQsendQuery                     = (delegate*<pg_conn, utf8cstring, int>)(Handle                                                                          + PQsendQueryRVA);
                PQsendQueryParams               = (delegate*<pg_conn, utf8cstring, int, uint*, utf8string*, int*, int*, int, int>)(Handle                                + PQsendQueryParamsRVA);
                PQsendPrepare                   = (delegate*<pg_conn, utf8cstring, utf8cstring, int, uint*, int>)(Handle                                                 + PQsendPrepareRVA);
                PQsendQueryPrepared             = (delegate*<pg_conn, utf8cstring, int, utf8string*, int*, int*, int, int>)(Handle                                       + PQsendQueryPreparedRVA);
                ...
                PQputCopyData                   = (delegate*<pg_conn, utf8cstring, int, int>)(Handle                                                                     + PQputCopyDataRVA);
                PQputCopyEnd                    = (delegate*<pg_conn, utf8cstring, int>)(Handle                                                                          + PQputCopyEndRVA);
                ...
                PQputline                       = (delegate*<pg_conn, utf8cstring, int>)(Handle                                                                          + PQputlineRVA);
                PQgetlineAsync                  = (delegate*<pg_conn, sbyte*, int, int>)(Handle                                                                          + PQgetlineAsyncRVA);
                PQputnbytes                     = (delegate*<pg_conn, utf8cstring, int, int>)(Handle                                                                     + PQputnbytesRVA);
                ...
                PQping                          = (delegate*<utf8cstring, PGPing>)(Handle                                                                                + PQpingRVA);
                ...
                PQresStatus                     = (delegate*<ExecStatusType, utf8cstring>)(Handle                                                                        + PQresStatusRVA);
                PQresultErrorMessage            = (delegate*<pg_result, utf8cstring>)(Handle                                                                             + PQresultErrorMessageRVA);
                PQresultVerboseErrorMessage     = (delegate*<pg_result, PGVerbosity, PGContextVisibility, utf8cstring>)(Handle                                           + PQresultVerboseErrorMessageRVA);
                PQresultErrorField              = (delegate*<pg_result, int, utf8cstring>)(Handle                                                                        + PQresultErrorFieldRVA);
                ...
                PQfname                         = (delegate*<pg_result, int, utf8cstring>)(Handle                                                                        + PQfnameRVA);
                PQfnumber                       = (delegate*<pg_result, utf8cstring, int>)(Handle                                                                        + PQfnumberRVA);
                PQftable                        = (delegate*<pg_result, int, Oid>)(Handle                                                                                + PQftableRVA);
                PQftablecol                     = (delegate*<pg_result, int, int>)(Handle                                                                                + PQftablecolRVA);
                PQfformat                       = (delegate*<pg_result, int, int>)(Handle                                                                                + PQfformatRVA);
                PQftype                         = (delegate*<pg_result, int, Oid>)(Handle                                                                                + PQftypeRVA);
                PQfsize                         = (delegate*<pg_result, int, int>)(Handle                                                                                + PQfsizeRVA);
                PQfmod                          = (delegate*<pg_result, int, int>)(Handle                                                                                + PQfmodRVA);
                PQcmdStatus                     = (delegate*<pg_result, utf8cstring>)(Handle                                                                             + PQcmdStatusRVA);
                PQoidStatus                     = (delegate*<pg_result, utf8cstring>)(Handle                                                                             + PQoidStatusRVA);
                PQoidValue                      = (delegate*<pg_result, Oid>)(Handle                                                                                     + PQoidValueRVA);
                PQcmdTuples                     = (delegate*<pg_result, utf8cstring>)(Handle                                                                             + PQcmdTuplesRVA);
                ...
                PQparamtype                     = (delegate*<pg_result, int, Oid>)(Handle                                                                                + PQparamtypeRVA);
                PQdescribePrepared              = (delegate*<pg_conn, utf8cstring, pg_result>)(Handle                                                                    + PQdescribePreparedRVA);
                PQdescribePortal                = (delegate*<pg_conn, utf8cstring, pg_result>)(Handle                                                                    + PQdescribePortalRVA);
                PQsendDescribePrepared          = (delegate*<pg_conn, utf8cstring, int>)(Handle                                                                          + PQsendDescribePreparedRVA);
                PQsendDescribePortal            = (delegate*<pg_conn, utf8cstring, int>)(Handle                                                                          + PQsendDescribePortalRVA);
                PQclear                         = (delegate*<pg_result, void>)(Handle                                                                                    + PQclearRVA);
                PQfreemem                       = (delegate*<nuint, void>)(Handle                                                                                        + PQfreememRVA);
                ...
                PQresultAlloc                   = (delegate*<pg_result, ulong, nuint>)(Handle                                                                            + PQresultAllocRVA);
                ...
                PQescapeStringConn              = (delegate*<pg_conn, utf8cstring, utf8cstring, ulong, int*, ulong>)(Handle                                              + PQescapeStringConnRVA);
                PQescapeLiteral                 = (delegate*<pg_conn, utf8cstring, ulong, utf8cstring>)(Handle                                                           + PQescapeLiteralRVA);
                PQescapeIdentifier              = (delegate*<pg_conn, utf8cstring, ulong, utf8cstring>)(Handle                                                           + PQescapeIdentifierRVA);
                PQescapeByteaConn               = (delegate*<pg_conn, utf8cstring, ulong, out ulong, utf8cstring>)(Handle                                                + PQescapeByteaConnRVA);
                PQunescapeBytea                 = (delegate*<utf8cstring, out ulong, utf8cstring>)(Handle                                                                + PQunescapeByteaRVA);
                PQescapeString                  = (delegate*<utf8cstring, utf8cstring, ulong, ulong>)(Handle                                                             + PQescapeStringRVA);
                PQescapeBytea                   = (delegate*<utf8cstring, ulong, ref ulong, utf8cstring>)(Handle                                                         + PQescapeByteaRVA);
                PQprint                         = (delegate*<ref _iobuf, pg_result, ref PQprintOpt, void>)(Handle                                                        + PQprintRVA);
                PQdisplayTuples                 = (delegate*<pg_result, ref _iobuf, int, utf8cstring, int, int, void>)(Handle                                            + PQdisplayTuplesRVA);
                ...
                lo_read                         = (delegate*<pg_conn, int, utf8cstring, ulong, int>)(Handle                                                              + lo_readRVA);
                lo_write                        = (delegate*<pg_conn, int, utf8cstring, ulong, int>)(Handle                                                              + lo_writeRVA);
                ...
                lo_import                       = (delegate*<pg_conn, utf8cstring, uint>)(Handle                                                                         + lo_importRVA);
                lo_import_with_oid              = (delegate*<pg_conn, utf8cstring, uint, uint>)(Handle                                                                   + lo_import_with_oidRVA);
                lo_export                       = (delegate*<pg_conn, uint, utf8cstring, int>)(Handle                                                                    + lo_exportRVA);
                PQlibVersion                    = (delegate*<int>)(Handle                                                                                                + PQlibVersionRVA);
                PQmblen                         = (delegate*<utf8cstring, int, int>)(Handle                                                                              + PQmblenRVA);
                PQdsplen                        = (delegate*<utf8cstring, int, int>)(Handle                                                                              + PQdsplenRVA);
                PQenv2encoding                  = (delegate*<int>)(Handle                                                                                                + PQenv2encodingRVA);
                PQencryptPassword               = (delegate*<utf8cstring, utf8cstring, utf8cstring>)(Handle                                                              + PQencryptPasswordRVA);
                PQencryptPasswordConn           = (delegate*<pg_conn, utf8cstring, utf8cstring, utf8cstring, utf8cstring>)(Handle                                        + PQencryptPasswordConnRVA);
                pg_char_to_encoding             = (delegate*<utf8cstring, int>)(Handle                                                                                   + pg_char_to_encodingRVA);
                pg_encoding_to_char             = (delegate*<int, utf8cstring>)(Handle                                                                                   + pg_encoding_to_charRVA);
                ...
                PQdefaultSSLKeyPassHook_OpenSSL = (delegate*<utf8cstring, int, pg_conn, int>)(Handle                                                                     + PQdefaultSSLKeyPassHook_OpenSSLRVA);
                PQregisterEventProc             = (delegate*<pg_conn, PGEventProc, utf8cstring, nuint, int>)(Handle                                                      + PQregisterEventProcRVA);
                PQsetInstanceData               = (delegate*<pg_conn, PGEventProc, nuint, int>)(Handle                                                                   + PQsetInstanceDataRVA);
                PQinstanceData                  = (delegate*<pg_conn, PGEventProc, nuint>)(Handle                                                                        + PQinstanceDataRVA);
                PQresultSetInstanceData         = (delegate*<pg_result, PGEventProc, nuint, int>)(Handle                                                                 + PQresultSetInstanceDataRVA);
                PQresultInstanceData            = (delegate*<pg_result, PGEventProc, nuint>)(Handle                                                                      + PQresultInstanceDataRVA);
        ...
        {
            string fullPath = Assembly.GetExecutingAssembly().
                                       Location;
        ...
        {
            OidTypes.Add((uint)OidKind.BOOLOID,
                         OidKind.BOOLOID);
            OidTypes.Add((uint)OidKind.BYTEAOID,
                         OidKind.BYTEAOID);
            OidTypes.Add((uint)OidKind.CHAROID,
                         OidKind.CHAROID);
            OidTypes.Add((uint)OidKind.NAMEOID,
                         OidKind.NAMEOID);
            OidTypes.Add((uint)OidKind.INT8OID,
                         OidKind.INT8OID);
            OidTypes.Add((uint)OidKind.INT2OID,
                         OidKind.INT2OID);
            OidTypes.Add((uint)OidKind.INT2VECTOROID,
                         OidKind.INT2VECTOROID);
            OidTypes.Add((uint)OidKind.INT4OID,
                         OidKind.INT4OID);
            OidTypes.Add((uint)OidKind.REGPROCOID,
                         OidKind.REGPROCOID);
            OidTypes.Add((uint)OidKind.TEXTOID,
                         OidKind.TEXTOID);
            OidTypes.Add((uint)OidKind.OIDOID,
                         OidKind.OIDOID);
            OidTypes.Add((uint)OidKind.TIDOID,
                         OidKind.TIDOID);
            OidTypes.Add((uint)OidKind.XIDOID,
                         OidKind.XIDOID);
            OidTypes.Add((uint)OidKind.CIDOID,
                         OidKind.CIDOID);
            OidTypes.Add((uint)OidKind.OIDVECTOROID,
                         OidKind.OIDVECTOROID);
            OidTypes.Add((uint)OidKind.JSONOID,
                         OidKind.JSONOID);
            OidTypes.Add((uint)OidKind.XMLOID,
                         OidKind.XMLOID);
            OidTypes.Add((uint)OidKind.PGNODETREEOID,
                         OidKind.PGNODETREEOID);
            OidTypes.Add((uint)OidKind.PGNDISTINCTOID,
                         OidKind.PGNDISTINCTOID);
            OidTypes.Add((uint)OidKind.PGDEPENDENCIESOID,
                         OidKind.PGDEPENDENCIESOID);
            OidTypes.Add((uint)OidKind.PGMCVLISTOID,
                         OidKind.PGMCVLISTOID);
            OidTypes.Add((uint)OidKind.PGDDLCOMMANDOID,
                         OidKind.PGDDLCOMMANDOID);
            OidTypes.Add((uint)OidKind.POINTOID,
                         OidKind.POINTOID);
            OidTypes.Add((uint)OidKind.LSEGOID,
                         OidKind.LSEGOID);
            OidTypes.Add((uint)OidKind.PATHOID,
                         OidKind.PATHOID);
            OidTypes.Add((uint)OidKind.BOXOID,
                         OidKind.BOXOID);
            OidTypes.Add((uint)OidKind.POLYGONOID,
                         OidKind.POLYGONOID);
            OidTypes.Add((uint)OidKind.LINEOID,
                         OidKind.LINEOID);
            OidTypes.Add((uint)OidKind.FLOAT4OID,
                         OidKind.FLOAT4OID);
            OidTypes.Add((uint)OidKind.FLOAT8OID,
                         OidKind.FLOAT8OID);
            OidTypes.Add((uint)OidKind.UNKNOWNOID,
                         OidKind.UNKNOWNOID);
            OidTypes.Add((uint)OidKind.CIRCLEOID,
                         OidKind.CIRCLEOID);
            OidTypes.Add((uint)OidKind.CASHOID,
                         OidKind.CASHOID);
            OidTypes.Add((uint)OidKind.MACADDROID,
                         OidKind.MACADDROID);
            OidTypes.Add((uint)OidKind.INETOID,
                         OidKind.INETOID);
            OidTypes.Add((uint)OidKind.CIDROID,
                         OidKind.CIDROID);
            OidTypes.Add((uint)OidKind.MACADDR8OID,
                         OidKind.MACADDR8OID);
            OidTypes.Add((uint)OidKind.ACLITEMOID,
                         OidKind.ACLITEMOID);
            OidTypes.Add((uint)OidKind.BPCHAROID,
                         OidKind.BPCHAROID);
            OidTypes.Add((uint)OidKind.VARCHAROID,
                         OidKind.VARCHAROID);
            OidTypes.Add((uint)OidKind.DATEOID,
                         OidKind.DATEOID);
            OidTypes.Add((uint)OidKind.TIMEOID,
                         OidKind.TIMEOID);
            OidTypes.Add((uint)OidKind.TIMESTAMPOID,
                         OidKind.TIMESTAMPOID);
            OidTypes.Add((uint)OidKind.TIMESTAMPTZOID,
                         OidKind.TIMESTAMPTZOID);
            OidTypes.Add((uint)OidKind.INTERVALOID,
                         OidKind.INTERVALOID);
            OidTypes.Add((uint)OidKind.TIMETZOID,
                         OidKind.TIMETZOID);
            OidTypes.Add((uint)OidKind.BITOID,
                         OidKind.BITOID);
            OidTypes.Add((uint)OidKind.VARBITOID,
                         OidKind.VARBITOID);
            OidTypes.Add((uint)OidKind.NUMERICOID,
                         OidKind.NUMERICOID);
            OidTypes.Add((uint)OidKind.REFCURSOROID,
                         OidKind.REFCURSOROID);
            OidTypes.Add((uint)OidKind.REGPROCEDUREOID,
                         OidKind.REGPROCEDUREOID);
            OidTypes.Add((uint)OidKind.REGOPEROID,
                         OidKind.REGOPEROID);
            OidTypes.Add((uint)OidKind.REGOPERATOROID,
                         OidKind.REGOPERATOROID);
            OidTypes.Add((uint)OidKind.REGCLASSOID,
                         OidKind.REGCLASSOID);
            OidTypes.Add((uint)OidKind.REGTYPEOID,
                         OidKind.REGTYPEOID);
            OidTypes.Add((uint)OidKind.REGROLEOID,
                         OidKind.REGROLEOID);
            OidTypes.Add((uint)OidKind.REGNAMESPACEOID,
                         OidKind.REGNAMESPACEOID);
            OidTypes.Add((uint)OidKind.UUIDOID,
                         OidKind.UUIDOID);
            OidTypes.Add((uint)OidKind.LSNOID,
                         OidKind.LSNOID);
            OidTypes.Add((uint)OidKind.TSVECTOROID,
                         OidKind.TSVECTOROID);
            OidTypes.Add((uint)OidKind.GTSVECTOROID,
                         OidKind.GTSVECTOROID);
            OidTypes.Add((uint)OidKind.TSQUERYOID,
                         OidKind.TSQUERYOID);
            OidTypes.Add((uint)OidKind.REGCONFIGOID,
                         OidKind.REGCONFIGOID);
            OidTypes.Add((uint)OidKind.REGDICTIONARYOID,
                         OidKind.REGDICTIONARYOID);
            OidTypes.Add((uint)OidKind.JSONBOID,
                         OidKind.JSONBOID);
            OidTypes.Add((uint)OidKind.JSONPATHOID,
                         OidKind.JSONPATHOID);
            OidTypes.Add((uint)OidKind.TXID_SNAPSHOTOID,
                         OidKind.TXID_SNAPSHOTOID);
            OidTypes.Add((uint)OidKind.INT4RANGEOID,
                         OidKind.INT4RANGEOID);
            OidTypes.Add((uint)OidKind.NUMRANGEOID,
                         OidKind.NUMRANGEOID);
            OidTypes.Add((uint)OidKind.TSRANGEOID,
                         OidKind.TSRANGEOID);
            OidTypes.Add((uint)OidKind.TSTZRANGEOID,
                         OidKind.TSTZRANGEOID);
            OidTypes.Add((uint)OidKind.DATERANGEOID,
                         OidKind.DATERANGEOID);
            OidTypes.Add((uint)OidKind.INT8RANGEOID,
                         OidKind.INT8RANGEOID);
            OidTypes.Add((uint)OidKind.RECORDOID,
                         OidKind.RECORDOID);
            OidTypes.Add((uint)OidKind.RECORDARRAYOID,
                         OidKind.RECORDARRAYOID);
            OidTypes.Add((uint)OidKind.CSTRINGOID,
                         OidKind.CSTRINGOID);
            OidTypes.Add((uint)OidKind.ANYOID,
                         OidKind.ANYOID);
            OidTypes.Add((uint)OidKind.ANYARRAYOID,
                         OidKind.ANYARRAYOID);
            OidTypes.Add((uint)OidKind.VOIDOID,
                         OidKind.VOIDOID);
            OidTypes.Add((uint)OidKind.TRIGGEROID,
                         OidKind.TRIGGEROID);
            OidTypes.Add((uint)OidKind.EVTTRIGGEROID,
                         OidKind.EVTTRIGGEROID);
            OidTypes.Add((uint)OidKind.LANGUAGE_HANDLEROID,
                         OidKind.LANGUAGE_HANDLEROID);
            OidTypes.Add((uint)OidKind.INTERNALOID,
                         OidKind.INTERNALOID);
            OidTypes.Add((uint)OidKind.OPAQUEOID,
                         OidKind.OPAQUEOID);
            OidTypes.Add((uint)OidKind.ANYELEMENTOID,
                         OidKind.ANYELEMENTOID);
            OidTypes.Add((uint)OidKind.ANYNONARRAYOID,
                         OidKind.ANYNONARRAYOID);
            OidTypes.Add((uint)OidKind.ANYENUMOID,
                         OidKind.ANYENUMOID);
            OidTypes.Add((uint)OidKind.FDW_HANDLEROID,
                         OidKind.FDW_HANDLEROID);
            OidTypes.Add((uint)OidKind.INDEX_AM_HANDLEROID,
                         OidKind.INDEX_AM_HANDLEROID);
            OidTypes.Add((uint)OidKind.TSM_HANDLEROID,
                         OidKind.TSM_HANDLEROID);
            OidTypes.Add((uint)OidKind.TABLE_AM_HANDLEROID,
                         OidKind.TABLE_AM_HANDLEROID);
            OidTypes.Add((uint)OidKind.ANYRANGEOID,
                         OidKind.ANYRANGEOID);
            OidTypes.Add((uint)OidKind.BOOLARRAYOID,
                         OidKind.BOOLARRAYOID);
            OidTypes.Add((uint)OidKind.BYTEAARRAYOID,
                         OidKind.BYTEAARRAYOID);
            OidTypes.Add((uint)OidKind.CHARARRAYOID,
                         OidKind.CHARARRAYOID);
            OidTypes.Add((uint)OidKind.NAMEARRAYOID,
                         OidKind.NAMEARRAYOID);
            OidTypes.Add((uint)OidKind.INT8ARRAYOID,
                         OidKind.INT8ARRAYOID);
            OidTypes.Add((uint)OidKind.INT2ARRAYOID,
                         OidKind.INT2ARRAYOID);
            OidTypes.Add((uint)OidKind.INT2VECTORARRAYOID,
                         OidKind.INT2VECTORARRAYOID);
            OidTypes.Add((uint)OidKind.INT4ARRAYOID,
                         OidKind.INT4ARRAYOID);
            OidTypes.Add((uint)OidKind.REGPROCARRAYOID,
                         OidKind.REGPROCARRAYOID);
            OidTypes.Add((uint)OidKind.TEXTARRAYOID,
                         OidKind.TEXTARRAYOID);
            OidTypes.Add((uint)OidKind.OIDARRAYOID,
                         OidKind.OIDARRAYOID);
            OidTypes.Add((uint)OidKind.TIDARRAYOID,
                         OidKind.TIDARRAYOID);
            OidTypes.Add((uint)OidKind.XIDARRAYOID,
                         OidKind.XIDARRAYOID);
            OidTypes.Add((uint)OidKind.CIDARRAYOID,
                         OidKind.CIDARRAYOID);
            OidTypes.Add((uint)OidKind.OIDVECTORARRAYOID,
                         OidKind.OIDVECTORARRAYOID);
            OidTypes.Add((uint)OidKind.JSONARRAYOID,
                         OidKind.JSONARRAYOID);
            OidTypes.Add((uint)OidKind.XMLARRAYOID,
                         OidKind.XMLARRAYOID);
            OidTypes.Add((uint)OidKind.POINTARRAYOID,
                         OidKind.POINTARRAYOID);
            OidTypes.Add((uint)OidKind.LSEGARRAYOID,
                         OidKind.LSEGARRAYOID);
            OidTypes.Add((uint)OidKind.PATHARRAYOID,
                         OidKind.PATHARRAYOID);
            OidTypes.Add((uint)OidKind.BOXARRAYOID,
                         OidKind.BOXARRAYOID);
            OidTypes.Add((uint)OidKind.POLYGONARRAYOID,
                         OidKind.POLYGONARRAYOID);
            OidTypes.Add((uint)OidKind.LINEARRAYOID,
                         OidKind.LINEARRAYOID);
            OidTypes.Add((uint)OidKind.FLOAT4ARRAYOID,
                         OidKind.FLOAT4ARRAYOID);
            OidTypes.Add((uint)OidKind.FLOAT8ARRAYOID,
                         OidKind.FLOAT8ARRAYOID);
            OidTypes.Add((uint)OidKind.CIRCLEARRAYOID,
                         OidKind.CIRCLEARRAYOID);
            OidTypes.Add((uint)OidKind.MONEYARRAYOID,
                         OidKind.MONEYARRAYOID);
            OidTypes.Add((uint)OidKind.MACADDRARRAYOID,
                         OidKind.MACADDRARRAYOID);
            OidTypes.Add((uint)OidKind.INETARRAYOID,
                         OidKind.INETARRAYOID);
            OidTypes.Add((uint)OidKind.CIDRARRAYOID,
                         OidKind.CIDRARRAYOID);
            OidTypes.Add((uint)OidKind.MACADDR8ARRAYOID,
                         OidKind.MACADDR8ARRAYOID);
            OidTypes.Add((uint)OidKind.ACLITEMARRAYOID,
                         OidKind.ACLITEMARRAYOID);
            OidTypes.Add((uint)OidKind.BPCHARARRAYOID,
                         OidKind.BPCHARARRAYOID);
            OidTypes.Add((uint)OidKind.VARCHARARRAYOID,
                         OidKind.VARCHARARRAYOID);
            OidTypes.Add((uint)OidKind.DATEARRAYOID,
                         OidKind.DATEARRAYOID);
            OidTypes.Add((uint)OidKind.TIMEARRAYOID,
                         OidKind.TIMEARRAYOID);
            OidTypes.Add((uint)OidKind.TIMESTAMPARRAYOID,
                         OidKind.TIMESTAMPARRAYOID);
            OidTypes.Add((uint)OidKind.TIMESTAMPTZARRAYOID,
                         OidKind.TIMESTAMPTZARRAYOID);
            OidTypes.Add((uint)OidKind.INTERVALARRAYOID,
                         OidKind.INTERVALARRAYOID);
            OidTypes.Add((uint)OidKind.TIMETZARRAYOID,
                         OidKind.TIMETZARRAYOID);
            OidTypes.Add((uint)OidKind.BITARRAYOID,
                         OidKind.BITARRAYOID);
            OidTypes.Add((uint)OidKind.VARBITARRAYOID,
                         OidKind.VARBITARRAYOID);
            OidTypes.Add((uint)OidKind.NUMERICARRAYOID,
                         OidKind.NUMERICARRAYOID);
            OidTypes.Add((uint)OidKind.REFCURSORARRAYOID,
                         OidKind.REFCURSORARRAYOID);
            OidTypes.Add((uint)OidKind.REGPROCEDUREARRAYOID,
                         OidKind.REGPROCEDUREARRAYOID);
            OidTypes.Add((uint)OidKind.REGOPERARRAYOID,
                         OidKind.REGOPERARRAYOID);
            OidTypes.Add((uint)OidKind.REGOPERATORARRAYOID,
                         OidKind.REGOPERATORARRAYOID);
            OidTypes.Add((uint)OidKind.REGCLASSARRAYOID,
                         OidKind.REGCLASSARRAYOID);
            OidTypes.Add((uint)OidKind.REGTYPEARRAYOID,
                         OidKind.REGTYPEARRAYOID);
            OidTypes.Add((uint)OidKind.REGROLEARRAYOID,
                         OidKind.REGROLEARRAYOID);
            OidTypes.Add((uint)OidKind.REGNAMESPACEARRAYOID,
                         OidKind.REGNAMESPACEARRAYOID);
            OidTypes.Add((uint)OidKind.UUIDARRAYOID,
                         OidKind.UUIDARRAYOID);
            OidTypes.Add((uint)OidKind.PG_LSNARRAYOID,
                         OidKind.PG_LSNARRAYOID);
            OidTypes.Add((uint)OidKind.TSVECTORARRAYOID,
                         OidKind.TSVECTORARRAYOID);
            OidTypes.Add((uint)OidKind.GTSVECTORARRAYOID,
                         OidKind.GTSVECTORARRAYOID);
            OidTypes.Add((uint)OidKind.TSQUERYARRAYOID,
                         OidKind.TSQUERYARRAYOID);
            OidTypes.Add((uint)OidKind.REGCONFIGARRAYOID,
                         OidKind.REGCONFIGARRAYOID);
            OidTypes.Add((uint)OidKind.REGDICTIONARYARRAYOID,
                         OidKind.REGDICTIONARYARRAYOID);
            OidTypes.Add((uint)OidKind.JSONBARRAYOID,
                         OidKind.JSONBARRAYOID);
            OidTypes.Add((uint)OidKind.JSONPATHARRAYOID,
                         OidKind.JSONPATHARRAYOID);
            OidTypes.Add((uint)OidKind.TXID_SNAPSHOTARRAYOID,
                         OidKind.TXID_SNAPSHOTARRAYOID);
            OidTypes.Add((uint)OidKind.INT4RANGEARRAYOID,
                         OidKind.INT4RANGEARRAYOID);
            OidTypes.Add((uint)OidKind.NUMRANGEARRAYOID,
                         OidKind.NUMRANGEARRAYOID);
            OidTypes.Add((uint)OidKind.TSRANGEARRAYOID,
                         OidKind.TSRANGEARRAYOID);
            OidTypes.Add((uint)OidKind.TSTZRANGEARRAYOID,
                         OidKind.TSTZRANGEARRAYOID);
            OidTypes.Add((uint)OidKind.DATERANGEARRAYOID,
                         OidKind.DATERANGEARRAYOID);
            OidTypes.Add((uint)OidKind.INT8RANGEARRAYOID,
                         OidKind.INT8RANGEARRAYOID);
            OidTypes.Add((uint)OidKind.CSTRINGARRAYOID,
                         OidKind.CSTRINGARRAYOID);
        }

        public static PostgreSQLType GetSqlType(OidKind type)
        {
            switch(type)
            {
                case OidKind.BOOLOID:
                {
                    return PostgreSQLType.BOOLEAN;
                }
                ...
                {
                    return PostgreSQLType.TINYINT;
                }
                case OidKind.INT2OID:
                {
                    return PostgreSQLType.SMALLINT;
                }
                case OidKind.INT4OID:
                {
                    return PostgreSQLType.INT;
                }
                ...
                {
                    return PostgreSQLType.VOID;
                }
                case OidKind.POINTOID:
                {
                    return PostgreSQLType.POINT;
                }
                case OidKind.POLYGONOID:
                {
                    return PostgreSQLType.POLYGON;
                }
                default:
                {
        ...
        /// <include file='docs/libpq-connect.html' path='html/body[docContent]/div[LIBPQ-CONNECT]/div/dl/dt[LIBPQ-PQCONNECTSTARTPARAMS]/@id' />
        public static unsafe delegate*<utf8cstring, pg_conn> PQconnectStart;

        /// <seealso href="link">docs/libpq-connect.html#LIBPQ-PQCONNECTSTARTPARAMS</seealso>
        ...
        public static unsafe delegate*<utf8cstring, pg_conn>                                                                               PQconnectdb;
        public static unsafe delegate*<utf8string*, utf8string*, int, pg_conn>                                                             PQconnectdbParams;
        public static unsafe delegate*<utf8cstring, utf8cstring, utf8cstring, utf8cstring, utf8cstring, utf8cstring, utf8cstring, pg_conn> PQsetdbLogin;
        public static unsafe delegate*<pg_conn, void>                                                                                      PQfinish;
        public static unsafe delegate*<ref PQconninfoOption>                                                                               PQconndefaults;
        public static unsafe delegate*<utf8cstring, utf8string*, ref PQconninfoOption>                                                     PQconninfoParse;
        ...
        public static unsafe delegate*<pg_cancel, utf8string, int, int>                                                                    PQcancel;
        public static unsafe delegate*<pg_conn, int>                                                                                       PQrequestCancel;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQdb;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQuser;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQpass;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQhost;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQhostaddr;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQport;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQtty;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQoptions;
        ...
        public static unsafe delegate*<pg_conn, utf8cstring, utf8cstring>                                                                  PQparameterStatus;
        public static unsafe delegate*<pg_conn, int>                                                                                       PQprotocolVersion;
        public static unsafe delegate*<pg_conn, int>                                                                                       PQserverVersion;
        public static unsafe delegate*<pg_conn, utf8string>                                                                                PQerrorMessage;
        ...
        public static unsafe delegate*<pg_conn, utf8cstring, int>                                                                          PQsetClientEncoding;
        public static unsafe delegate*<pg_conn, int>                                                                                       PQsslInUse;
        public static unsafe delegate*<pg_conn, utf8cstring, nuint>                                                                        PQsslStruct;
        public static unsafe delegate*<pg_conn, utf8cstring, utf8cstring>                                                                  PQsslAttribute;
        public static unsafe delegate*<pg_conn, utf8cstring*>                                                                              PQsslAttributeNames;
        public static unsafe delegate*<pg_conn, nuint>                                                                                     PQgetssl;
        ...
        public static unsafe delegate*<pg_conn, nuint>                                                                                     PQgetgssctx;
        ...
        public static unsafe delegate*<pg_conn, PQnoticeReceiver, nuint, PQnoticeReceiver>                                                 PQsetNoticeReceiver;
        public static unsafe delegate*<pg_conn, PQnoticeProcessor, nuint, PQnoticeProcessor>                                               PQsetNoticeProcessor;
        public static unsafe delegate*<pgthreadlock_t, pgthreadlock_t>                                                                     PQregisterThreadLock;
        public static unsafe delegate*<pg_conn, utf8cstring, pg_result>                                                                    PQexec;
        public static unsafe delegate*<pg_conn, utf8cstring, int, Oid*, utf8string*, int*, int*, int, pg_result>                           PQexecParams;
        public static unsafe delegate*<pg_conn, utf8cstring, utf8cstring, int, Oid*, pg_result>                                            PQprepare;
        public static unsafe delegate*<pg_conn, utf8cstring, int, utf8string*, int*, int*, int, pg_result>                                 PQexecPrepared;
        public static unsafe delegate*<pg_conn, utf8cstring, int>                                                                          PQsendQuery;
        public static unsafe delegate*<pg_conn, utf8cstring, int, uint*, utf8string*, int*, int*, int, int>                                PQsendQueryParams;
        public static unsafe delegate*<pg_conn, utf8cstring, utf8cstring, int, uint*, int>                                                 PQsendPrepare;
        public static unsafe delegate*<pg_conn, utf8cstring, int, utf8string*, int*, int*, int, int>                                       PQsendQueryPrepared;
        ...
        public static unsafe delegate*<pg_conn, utf8cstring, int, int>                                                                     PQputCopyData;
        public static unsafe delegate*<pg_conn, utf8cstring, int>                                                                          PQputCopyEnd;
        ...
        public static unsafe delegate*<pg_conn, utf8cstring, int>                                                                          PQputline;
        public static unsafe delegate*<pg_conn, sbyte*, int, int>                                                                          PQgetlineAsync;
        public static unsafe delegate*<pg_conn, utf8cstring, int, int>                                                                     PQputnbytes;
        ...
        public static unsafe delegate*<utf8cstring, PGPing>                                                                                PQping;
        ...
        public static unsafe delegate*<ExecStatusType, utf8cstring>                                                                        PQresStatus;
        public static unsafe delegate*<pg_result, utf8cstring>                                                                             PQresultErrorMessage;
        public static unsafe delegate*<pg_result, PGVerbosity, PGContextVisibility, utf8cstring>                                           PQresultVerboseErrorMessage;
        public static unsafe delegate*<pg_result, int, utf8cstring>                                                                        PQresultErrorField;
        ...
        public static unsafe delegate*<pg_result, int, utf8cstring>                                                                        PQfname;
        public static unsafe delegate*<pg_result, utf8cstring, int>                                                                        PQfnumber;
        public static unsafe delegate*<pg_result, int, Oid>                                                                                PQftable;
        public static unsafe delegate*<pg_result, int, int>                                                                                PQftablecol;
        public static unsafe delegate*<pg_result, int, int>                                                                                PQfformat;
        public static unsafe delegate*<pg_result, int, Oid>                                                                                PQftype;
        public static unsafe delegate*<pg_result, int, int>                                                                                PQfsize;
        public static unsafe delegate*<pg_result, int, int>                                                                                PQfmod;
        public static unsafe delegate*<pg_result, utf8cstring>                                                                             PQcmdStatus;
        public static unsafe delegate*<pg_result, utf8cstring>                                                                             PQoidStatus;
        public static unsafe delegate*<pg_result, Oid>                                                                                     PQoidValue;
        public static unsafe delegate*<pg_result, utf8cstring>                                                                             PQcmdTuples;
        ...
        public static unsafe delegate*<pg_result, int, Oid>                                                                                PQparamtype;
        public static unsafe delegate*<pg_conn, utf8cstring, pg_result>                                                                    PQdescribePrepared;
        public static unsafe delegate*<pg_conn, utf8cstring, pg_result>                                                                    PQdescribePortal;
        public static unsafe delegate*<pg_conn, utf8cstring, int>                                                                          PQsendDescribePrepared;
        public static unsafe delegate*<pg_conn, utf8cstring, int>                                                                          PQsendDescribePortal;
        public static unsafe delegate*<pg_result, void>                                                                                    PQclear;
        public static unsafe delegate*<nuint, void>                                                                                        PQfreemem;
        ...
        public static unsafe delegate*<pg_result, ulong, nuint>                                                                            PQresultAlloc;
        ...
        public static unsafe delegate*<pg_conn, utf8cstring, utf8cstring, ulong, int*, ulong>                                              PQescapeStringConn;
        public static unsafe delegate*<pg_conn, utf8cstring, ulong, utf8cstring>                                                           PQescapeLiteral;
        public static unsafe delegate*<pg_conn, utf8cstring, ulong, utf8cstring>                                                           PQescapeIdentifier;
        public static unsafe delegate*<pg_conn, utf8cstring, ulong, out ulong, utf8cstring>                                                PQescapeByteaConn;
        public static unsafe delegate*<utf8cstring, out ulong, utf8cstring>                                                                PQunescapeBytea;
        public static unsafe delegate*<utf8cstring, utf8cstring, ulong, ulong>                                                             PQescapeString;
        public static unsafe delegate*<utf8cstring, ulong, ref ulong, utf8cstring>                                                         PQescapeBytea;
        public static unsafe delegate*<ref _iobuf, pg_result, ref PQprintOpt, void>                                                        PQprint;
        public static unsafe delegate*<pg_result, ref _iobuf, int, utf8cstring, int, int, void>                                            PQdisplayTuples;
        ...
        public static unsafe delegate*<pg_conn, int, utf8cstring, ulong, int>                                                              lo_read;
        public static unsafe delegate*<pg_conn, int, utf8cstring, ulong, int>                                                              lo_write;
        ...
        public static unsafe delegate*<pg_conn, utf8cstring, uint>                                                                         lo_import;
        public static unsafe delegate*<pg_conn, utf8cstring, uint, uint>                                                                   lo_import_with_oid;
        public static unsafe delegate*<pg_conn, uint, utf8cstring, int>                                                                    lo_export;
        public static unsafe delegate*<int>                                                                                                PQlibVersion;
        public static unsafe delegate*<utf8cstring, int, int>                                                                              PQmblen;
        public static unsafe delegate*<utf8cstring, int, int>                                                                              PQdsplen;
        public static unsafe delegate*<int>                                                                                                PQenv2encoding;
        public static unsafe delegate*<utf8cstring, utf8cstring, utf8cstring>                                                              PQencryptPassword;
        public static unsafe delegate*<pg_conn, utf8cstring, utf8cstring, utf8cstring, utf8cstring>                                        PQencryptPasswordConn;
        public static unsafe delegate*<utf8cstring, int>                                                                                   pg_char_to_encoding;
        public static unsafe delegate*<int, utf8cstring>                                                                                   pg_encoding_to_char;
        ...
        public static unsafe delegate*<utf8cstring, int, pg_conn, int>                                                                     PQdefaultSSLKeyPassHook_OpenSSL;
        public static unsafe delegate*<pg_conn, PGEventProc, utf8cstring, nuint, int>                                                      PQregisterEventProc;
        public static unsafe delegate*<pg_conn, PGEventProc, nuint, int>                                                                   PQsetInstanceData;
        public static unsafe delegate*<pg_conn, PGEventProc, nuint>                                                                        PQinstanceData;
        public static unsafe delegate*<pg_result, PGEventProc, nuint, int>                                                                 PQresultSetInstanceData;
        public static unsafe delegate*<pg_result, PGEventProc, nuint>                                                                      PQresultInstanceData;
